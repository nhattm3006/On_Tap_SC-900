...
- 📚 **Full DUMP Mastery Mode**: Sequentially study the entire question bank. Features pagination, progression tracking, randomized question orders, and local storage auto-save so you can resume anytime.
...
- 📚 **Cày toàn bộ DUMP (Mastery)**: Ôn luyện duyệt qua toàn bộ ngân hàng câu hỏi. Có hệ thống phân trang, trộn ngẫu nhiên bộ đề khi khởi động, thanh báo cáo tiến độ và tự động lưu quá trình học vào trình duyệt.
...
3. **Mastery Mode (Cày DUMP)**:
   - Navigate to the `Cày toàn bộ DUMP` tab.
   - Study 20 questions per page with randomized order.
   - Grade your page and save your progress automatically. Return anytime to seamlessly resume.
4. **Practice (AI)**:
...
3. **Cày toàn bộ DUMP (Mastery)**:
   - Mở tab `Cày toàn bộ DUMP`.
   - Làm tuần tự 20 câu/trang với bộ câu hỏi đã được trộn ngẫu nhiên.
   - Nhấp "Chấm điểm và Lưu" để biết kết quả lập tức và hệ thống sẽ tự động lưu lại. Bạn có thể thoát trình duyệt và học tiếp vào lúc khác.
4. **Luyện tập AI (AI Practice)**:
